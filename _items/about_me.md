...
| **Experiência:**| +8 anos de experiência de mercado. |
| **Comunidade:**| Contribuição em projetos de código aberto. |
| **Certificações:**| DCPT, OSCP, EHPX, Web API Exploitation. |
| **Projetos:**| Mobile Framework, Fraud as a Service, DAST + Auth, Pentest Report |
